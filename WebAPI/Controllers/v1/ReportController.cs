...
using RutaLimpiaBackend.Core.Application.Features.ReportFeatures.Commands.ChangeState;
...
namespace WebAPI.Controllers.v1
{
    ...
    public class ReportController : BaseApiController
    {
        ...
        public async Task<IActionResult> Create([FromForm] CreateReportCommand command)
        {
        ...
        [HttpPut("ChangeState")]
        [Consumes(MediaTypeNames.Application.Json)]
        public async Task<IActionResult> ChangeState([FromBody] ChangeReportStateCommand command)
        {
            return Ok(await Mediator.Send(command));
        }
    }
